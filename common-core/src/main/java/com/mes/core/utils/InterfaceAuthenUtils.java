...
/**
  * 类名称:    [InterfaceAuthenUtils]  
  * 类描述:    [接口认证工具类,采用HAMC加密算法 秘钥进行base64编码,需要解码]
  * 创建人:    [liukl]   
  * 版本:      [v1.0]   
 */
public class InterfaceAuthenUtils {
	 ...
	 * @throws IOException
	 */
	public static String signTopRequestNew(Map<String, String> params, String secret) throws IOException {
